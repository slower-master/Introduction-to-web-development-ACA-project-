...
function validateCommandLineParams(envVars, paramSpec) {
    if (_.size(envVars) > _.size(paramSpec)) {
        ...
        logger_1.logger.info("Warning: The following params were specified in your env file but do not exist in the extension spec: " +
            `${misnamedParams.join(", ")}.`);
    }
...
function isUrlPath(extInstallPath) {
    return exports.urlRegex.test(extInstallPath);
}
