...
class FunctionsEmulator {
    ...
    async loadTriggers(force = false) {
        ...
        for (const definition of toSetup) {
            ...
            if (definition.httpsTrigger) {
                ...
                const { host, port } = this.getInfo();
                added = true;
                url = FunctionsEmulator.getHttpFunctionUrl(host, port, this.args.projectId, definition.name, region);
            }
    ...
    async handleHttpsTrigger(req, res) {
        ...
        const path = `${url.pathname}${url.search}`.replace(new RegExp(`\/${this.args.projectId}\/[^\/]*\/${triggerId}\/?`), "/");
